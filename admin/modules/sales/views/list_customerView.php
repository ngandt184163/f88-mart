                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <ul class="list-operation fl-right">
                                            <li><a href="?mod=users&controller=team&action=updateInfoUser&email=<?php echo $customer['email']; ?>" title="Sửa" class="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></li>
                                            <li><a href="?mod=users&controller=team&action=deleteUser&email=<?php echo $customer['email']; ?>" title="Xóa" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                        </ul>
                                    </td>
                                    ...
                                    <td><span class="tbody-text"><?php echo $customer['order_count']; ?></span></td>
