        ...
        <div id="content" class="fl-right">           
            <div class="section" id="title-page">
                <div class="clearfix">
                    ...
                    <a href="?mod=post&controller=index&action=addPost" title="" id="add-new" class="fl-left">Thêm mới</a>
                </div>
            </div>            
                        ...
                        <table class="table list-table-wp">
                            <thead>
                                <tr>
                                    ...
                                    <td><span class="thead-text">post_id</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="clearfix">
                                                <div class="tb-title fl-left">
                                                    <a href="" title=""><?php echo $post['post_id']; ?></a>
                                                </div>
                                                <ul class="list-operation fl-right">
                                                    <li><a href="?mod=post&controller=index&action=updatePost&post_id=<?php echo $post['post_id']; ?>" title="Sửa" class="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></li>
                                                    <li><a href="?mod=post&controller=index&action=deletePost&post_id=<?php echo $post['post_id']; ?>" title="Xóa" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                                </ul>
                                            </td>
                                            <td><span class="tbody-text"><?php echo $post['title']; ?></span></td>
                                            <td><span class="tbody-text"><?php echo $post['slug']; ?></span></td>
                                            <td><span class="tbody-text"><?php echo $post['image']; ?></span></td>
                                            <td><span class="tbody-text"><?php echo $post['content']; ?></span></td>
                                            <td><span class="tbody-text"><?php echo get_info_category($post['category_id'], "name"); ?></span></td>
                                            <td><span class="tbody-text"><?php echo get_info_user($post['user_id'], "", "name") ?></span></td>
