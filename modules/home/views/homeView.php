        ...
        <div class="main-content fl-right">
            ...
            <div class="section" id="feature-product-wp">
                ...
                <div class="section-detail">
                    <ul class="list-item">
                        <li>
                            <a href="?mod=product&controller=index&action=detailProduct" title="" class="thumb">
                                <img src="public/images/img-pro-05.png">
                            </a>
                            <a href="?mod=product&controller=index&action=detailProduct" title="" class="product-name">Laptop Lenovo IdeaPad 120S</a>
                            <div class="price">
